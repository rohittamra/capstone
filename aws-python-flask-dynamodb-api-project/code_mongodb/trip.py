...
from code_mongodb.taxi import tripTaxiOn,checkIfExists
from code_mongodb.user import checkIfUserExists
from code_mongodb.taxi_location import editlocation, updateLocation, updateStatus

tripnamespace = Blueprint('trip', __name__)

db_uri = 'mongodb://localhost:27017'
client = pymongo.MongoClient(db_uri)
trip_table = 'USER_TRIP'
